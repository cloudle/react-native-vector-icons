...
const NativeIconAPI = NativeModules ?
  (NativeModules.RNVectorIconsManager || NativeModules.RNVectorIconsModule) : undefined;
...
export default function createIconSet(glyphMap, fontFamily, fontFile) {
  ...
  if (Platform.OS === 'web') {
    const fontPath = require(`./node_modules/react-native-vector-icons/Fonts/${fontFile}`);
    const css = `@font-face {
